    ...
    <hr>
        <form method="post" enctype="multipart/form-data">
            ...
            if(isset($_POST['submit'])){
                ...
                $sel_old_pass = "select * from customers where customer_pword ='$c_old_pass'";
                ...
                if($check_c_old_pass == 0){
                    ...
                    echo "<script>alert('Sorry, your current passowrd is not valid. Please try again')</script>";
                ...
                $update_c_pass = "update customers set customer_pword = '$c_new_pass' where customer_email = '$c_email'";
